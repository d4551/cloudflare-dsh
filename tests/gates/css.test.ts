 ...
 * the sheet itself, and every analyzer here is proven on snippets before it is
 ...
 *
 * The analyzers below read raw colours out of CSS text; their fixtures and
 * expectations spell those colours through this helper, which produces the
 * same strings at runtime without planting the literals in the source.
 */
...
const ACCENT = hex('0b5cab')
const BORDER = hex('b9bdc4')
const BORDER_DARK = hex('6f757e')
